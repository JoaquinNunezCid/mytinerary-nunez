...
const Main = () => {
    return (
        <section>
            ...
            <div className="main">
                <div>
                    <img className="logo" src={logo1} alt="logo avion dando vuelta al mundo"></img>
                    <p className="choose">We are the leaders in the traveling market to America and Europe</p>
                </div>
                <div>
                    <img className="logo" src={logo2} alt="Logo bolsa de dinero en mano"></img>
                    <p className="choose">We have the lowest prices</p>
                </div>
                <div>
                    <img className="logo" src={logo3} alt="Logo pasaporte"></img>
